            ...
            <div class="col-sm-10 col-xs-12" id="main">
                <nav class="navbar navbar-default" id="nav">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand clickable hide fa fa-arrow-{{$dir=='ltr'?'left':'right'}}"
                           id="to-previous" style="color: #000431   !important;>
              <i class=">
                        ...
                        <div class="form-group" id="attachment">
                            ...
                            <div class="controls">
                                <div class="input-group" style="width: 100%">
                                    <input type="file" class="doc-upload" id="upload" name="upload[]"
                                           multiple="multiple">
                                </div>
                            </div>
                        </div>
