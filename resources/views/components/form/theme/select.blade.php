...
<div class="{{$contClass}}">
    ...
    {!!Form::select($name,$dataAttr,null,['id'=>$id,'data-msg'=>trans((!$errorMsg)?'validation.custom.required':$errorMsg),'class'=>'sm-form-control '.$class.(($required===true)?' required':''),'placeholder'=>$placeholder]) !!}
</div>