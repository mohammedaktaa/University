@php $class=isset($isTextEditor)&&$isTextEditor?$class.' text-editor ':$class;
...
<div class="{{$contClass}}">
    ...
    <div class="clear"></div>
    {!! Form::textarea($name,$value,['id'=>$id,'data-msg'=>trans((!$errorMsg)?'validation.custom.required':$errorMsg),'class'=>'form-control '.$class.(($required===true)?' required':''),'rows'=>$rows  ,'cols'=>$cols,'placeholder'=>$placeholder,'style'=>'resize: vertical;']) !!}
</div>