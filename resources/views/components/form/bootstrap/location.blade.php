<div class="{{$contClass}} nopadding">
    {!! Form::bsText('no'.$left.'padding col-sm-6','geo_lang','app.latitude','',$required) !!}
    {!! Form::bsText('col-sm-5','geo_long','app.longitude','',$required) !!}
    <button type="button" class="  topmargin-sm button button-red button-small bottommargin-xs icon-location"
            id="change_location" data-toggle='modal' data-target='#component-modal-location'></button>
</div>
