...
<div class="{{$contClass}}">
    ...
    {!! Form::input($type,$name,null,['id'=>$id,'data-msg'=>trans((!$errorMsg)?'validation.custom.required':$errorMsg),'class'=>'form-control '.$class.(($required===true)?' required':''),'placeholder'=>trans($placeholder or '')]) !!}
</div>