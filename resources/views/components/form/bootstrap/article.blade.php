...
{!!Form::bsText($extraContClass['title_en'],'title_en','app.title','',true,null,null,null,'','en') !!}
{!!Form::bsText($extraContClass['title_ar'],'title_ar','app.title','',true,null,null,null,'','ar') !!}
...
{{--@if($extraDate['display'])
    {!!Form::bsText($extraContClass['date'],'date','app.date','',$extraDate['required'],null,null,null,'date') !!}
@endif--}}
{{--@if($extraAddress['display'])
    {!!Form::bsText($extraContClass['address_en'],'address_en','profile.address','',$extraAddress['required'],null,null,null,'','en') !!}
    {!!Form::bsText($extraContClass['address_ar'],'address_ar','profile.address','',$extraAddress['required'],null,null,null,'','ar') !!}
@endif--}}
...
<div class="tabs tabs-alt clearfix" id="">
    ...
    <div class="tab-container noborder">
        <div class="tab-content clearfix" id="tab-en">
            {!!Form::bsTextArea('col_full','content_en',false,'',true,null,null,100,null,'',true,'en') !!}
        </div>
        <div class="tab-content clearfix" id="tab-ar">
            {!!Form::bsTextArea('col_full','content_ar',false,'',true,null,null,100,null,'',true,'ar') !!}
        </div>
        @if($extraImage['display'])
